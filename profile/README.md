...
|---|---|
| [ninjaone-scripts](https://github.com/mennotech/ninjaone-scripts) | Scripts for managing systems with NinjaOne RMM |
| [mt-rmm-scripts](https://github.com/mennotech/mt-rmm-scripts) | Collection of scripts used to manage systems |
| [powerschool-api](https://github.com/mennotech/powerschool-api) | PowerSchool API documentation for integrations |
| [fs-enrollment-pssync](https://github.com/mennotech/fs-enrollment-pssync) | FinalSite Enrollment to PowerSchool SIS sync scripts |
| [mt-zabbix-scripts](https://github.com/mennotech/mt-zabbix-scripts) | Zabbix monitoring scripts for computer systems |
| [windows-auto-shutdown](https://github.com/mennotech/windows-auto-shutdown) | Windows auto-shutdown script for power failures |
